...
public class NaiveBayesTool {
    ...
    */
    public static void main(String[] args ) throws IOException {
        ...
        NBayes.ReadFile("src/Bayes/CarSample.txt" ); //获取训练样本
    ...
    * */
    ...
    public void Calculated_probability()
    {
        ...
        for (int i =0;i <ClassValues . length ; i ++) {
            ...
            //System.out.println("ClassValue_gl[i]:"+ClassValue_gl[i]);
        }
    ...
    {
        BufferedReader br=new BufferedReader(new FileReader("src/Bayes/CarTest.txt" )); 
        String temp ;
        temp =br.readLine();
        int count=1;
        String []str = null ;
        ...
        while (temp !=null ){
          if(count>1350){
            ...
            predictTotal ++;
            //System.out.println(predictTotal);
            Data .addElement(Car );
            calculate(Car );
          }
            temp =br .readLine();
    ...
    public void calculate(Property car ){
		...
		// 计算在unacc,acc,good,vgood下的概率
			itemGl = 0;
			//System.out.println(buy_Vlaue_gl[b][i]);
